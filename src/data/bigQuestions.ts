...
export const bigQuestions: BigQuestion[] = [
  {
    id: 1,
    question: '200m급 목조 대공간 건축물은 어떻게 탄소중립 건설을 실현할 수 있을까?',
    icon: 'Sprout',
    image: '/images/leeseunglab/icon-crop.png',
    content: [
      '목재는 건축 재료 중 유일하게 탄소를 저장하는 구조 재료로, 대형 건축물의 내재 탄소를 획기적으로 저감할 수 있는 잠재력을 가지고 있습니다. 최근 공학 목재, 하이브리드 구조시스템, 모듈화 시공 기술의 발전은 목조 건축의 적용 범위를 기존 중·소규모 건축물에서 초대형 대공간 건축물로 확장시키고 있습니다. ',
      '그로나 200m급 초대형 목조 대공간 건축물을 구현하기 위해서는 구조 성능 확보, 시공성, 장기 내구성, 환경·에너지 성능 평가 등 다양한 기술적 과제를 동시에 해결해야 합니다. 기존의 설계 및 시공 방식만으로는 이러한 복합적인 요구를 체계적으로 충족하기에는 한계가 존재합니다.',
    ],
    highlights: [
      '그럼에도 불구하고, 초대형 목조 대공간 건축물을 대상으로 구조 시스템, OSC 기반 모듈화 설계,  환경·에너지 성능 평가, 스마트 시공 및 유지관리 기술을 통합적으로 개발한 연구는 아직 충분하지 않습니다.',
    ],
    bulletPoints: [
      '200m급 대공간을 위한 고성능 하이브리드 목조 구조 시스템 개발',
      'OSC 기반 모듈화 시공 및 탄소중립 설계 기술',
      '목조 대공간 건축물의 친환경·에너지 성능 평가 기술',
      '스마트 시공 및 전 생애주기 유지관리 기술'
    ],
  },
  {
    id: 2,
    question: '[1세부] 고성능 하이브르드 대단면 목조 구조 기술 개발',
    icon: 'TreeDeciduous',
    image: '/images/leeseunglab/icon-robin.png',
    content: [
      '200m급 목조 대공간 건축물을 실현하기 위해서는 초대형 구조 시스템에 적합한 안정성과 신뢰성을 확보하는 것이 필수적입니다.',
      '본 세부과제는 대규모 목조 구조에 요구되는 성능을 충족하면서도 현장 적용이 가능한 구조 기술을 개발하여, 초대형 목조 대공간 건축물 구현의 구조적 기반을 마련하는데 목적이 있습니다.',
    ],
    highlights: [],
    bulletPoints: [],
  },
  {
    id: 3,
    question: '[2세부] OSC 기반 목조 대공간 모듈화·탄소중립 설계 기술 개발',
    icon: 'Leaf',
    image: '/images/leeseunglab/icon-absorb.png',
    content: [
      '200m급 목조 대공간 건축물을 구현을 위해서는 대규모 구조를 효율적으로 계획하고 시공할 수 있는 설계·구성 방식이 필요합니다.',
      '본 세부과제는 OSC 기반 모듈화 개념을 적용하여 설계 및 시공의 효율성을 높이고, 탄소 배출을 고려한 합리적인 건축물 구성 방안을 제시하는 것을 목표로 합니다.',
    ],
    highlights: [],
    bulletPoints: [],
  },
  {
    id: 4,
    question: '[3세부] 목조 대공간 건축물 친환경·에너지 성능 평가 기술 개발',
    icon: 'Thermometer',
    image: '/images/leeseunglab/icon-climate.png',
    content: [
      '초대형 목조 대공간 건축물의 지속가능성을 확보하기 위해서는 환경적 성능과 에너지 효율에 대한 체계적인 평가가 요구됩니다.',
      '본 세부과제는 목조 대공간 건축물의 특성을 고려하여 환경·에너지 성능을 종합적으로 검토하고, 설계 및 운영 단계에서 활용 가능한 평가 기반을 마련하는데 목적이 있습니다.',
    ],
    highlights: [],
    bulletPoints: [],
  },
